	...
	<section class="section-core section-core section-news-slider" props="{}">
		<div class="section-news-slider__wrapper wrapper">
			<div class="section-news-slider__flex grid-flex grid-flex_justify-space-beetwen grid-flex_vertical-center">
				...
				<?php if($mainLink): ?>
					<a class="section-news-slider__button section-news-slider__button_desktop ui-button ui-button_type_default ui-button_size_default" href="<?php echo $mainLink; ?>">
			...
			<?php if($mainLink): ?>
				<a class="section-news-slider__button section-news-slider__button_mobile ui-button ui-button_type_default ui-button_size_default" href="<?php echo $mainLink; ?>">
					<span class="ui-button__text">Все новости</span>
				</a>
			<?php endif; ?>
		</div>
