...
get_header();
?>
<main class="part-main-content part-main-content_overflow-auto">
	...
	<section class="section-core section-core section-about">
		...
		<div class="section-about__diving">
			<div class="section-about__decors wrapper grid-flex grid-flex_justify-center">
			...
			<div class="section-about__diving-parent wrapper">
